...
ELIF _COMPACT
 PUTFILE "3-assembled-output/M128Elt.bin", "ELTME", &000E00, &000E43
 PUTFILE "3-assembled-output/BDATA.bin", "ELTMD", &001300, &001300
 PUTFILE "3-assembled-output/BCODE.bin", "ELTMC", &001300, &002C6C
ENDIF
